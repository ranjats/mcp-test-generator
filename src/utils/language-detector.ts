...
export function detectLanguage(projectPath: string): ProgrammingLanguage {
...
export function detectFramework(projectPath: string): ProjectFramework {
...
export function getSourceExtensions(language: ProgrammingLanguage): string[] {
  switch (language) {
    case "typescript":
      return [".ts", ".tsx"];
    case "javascript":
