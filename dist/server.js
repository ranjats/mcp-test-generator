            ...
            tools: [
                {
                    ...
                    description: "Analyzes the entire project and generates test case files for all testable source files. Supports TypeScript, JavaScript, Python, and Java projects.",
                    inputSchema: {
                        type: "object",
                        properties: {
                            projectPath: {
                            ...
                            testFramework: {
                                ...
                                description: "Test framework to use. Use 'auto' to detect from project config.",
                                default: "auto",
                            },
                            outputDir: {
                                type: "string",
                                description: "Output directory for test files (relative to project root). Defaults to '__tests__' or 'tests' based on convention.",
                            },
                            testStyle: {
                                type: "string",
                            ...
                            excludePatterns: {
                                type: "array",
                                items: { type: "string" },
                                description: "Glob patterns for files to exclude (e.g., ['**/*.d.ts'])",
                            },
                            overwrite: {
                                type: "boolean",
                ...
                },
                {
                    ...
                    description: "Analyzes a project and returns information about its structure, detected language, framework, and testable components without generating tests.",
                    inputSchema: {
                        type: "object",
                        properties: {
                            projectPath: {
                ...
                },
                {
                    ...
                    description: "Generates test cases for a single source file.",
                    inputSchema: {
                        type: "object",
                        properties: {
                            filePath: {
